...
Page({
    ...
    onLoad() {
        ...
        app.wx.getSystemInfo().then(res => {
            ...
            itemData.forEach(item => {
                item.width = res.windowWidth - 30
                item.height = res.windowWidth
    ...
    startTouchItem(obj) {
        ...
        curItem.class = 'item item-normal item-focus'
        this.setData({
            itemData: itemData
        })
    ...
    endTouchItem(obj) {
        ...
        curItem.animation = animation.export()
        curItem.class = 'item item-normal'
        this.setData({
            itemData: itemData
        })
    ...
    tapToOpen(obj) {
        ...
        if (curItem.opened) {
            ...
            curItem.animation = animation.export()
            curItem.class = 'item item-normal'
            curItem.width = this.data.clientWidth-30
            curItem.height = this.data.clientWidth
            ...
            animation.width(this.clientWidth).height(this.clientHeight).step()
            curItem.animation = animation.export()
            curItem.class = 'item item-opened'
            curItem.width = this.data.clientWidth
            curItem.height = this.data.clientHeight
            curItem.opened = true
        }
        this.setData({
            itemData: itemData
